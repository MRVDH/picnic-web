...
export default function DeliveryDetailPage() {
  ...
  const handleRate = useCallback(
    async (rating: number) => {
      ...
      const data = (await res.json()) as Partial<ApiErrorResponse>;
      if (!res.ok || data.error) {
        setToast(data.error === "Delivery already rated" ? t.deliveriesRateAlready : t.deliveriesRateError);
  ...
  const scenarioInProgress =
    tracking.status === "ready" ? tracking.data.scenarioInProgress : false;
